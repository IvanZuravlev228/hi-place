    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers(HttpMethod.POST, "/auth/login", "/auth/register", "/auth/confirm-email")
                            .permitAll();
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/images", "/images/main", "/images/user/{userId}")
                            .permitAll();
                    auth.requestMatchers(HttpMethod.POST, "/images/examples/user/{userId}")
                            .hasAnyRole(User.UserType.MASTER.name(), User.UserType.SALON.name());
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/type-service/{mainTypeId}", "/type-service/user/{userId}")
                            .permitAll();

                    auth.requestMatchers(HttpMethod.GET, "/user/type-of-service/city/{city}", "/user/main-service/city/{city}", "/user/service-item/city/{city}", "/user/{userId}")
                            .permitAll();
